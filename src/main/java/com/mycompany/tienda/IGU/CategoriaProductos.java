...
private Categoria categoria;
    ...
    CategoriaProductos(Categoria categoria) {
            initComponents();
            this.categoria = categoria;

            setTitle("Productos de la categoría: " + categoria.getDescripcion());
            setLocationRelativeTo(null);
            setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
            cargarProductos(categoria);
    }
    public CategoriaProductos() {
    // Este ya no hace falta si siempre usás el que recibe la categoría
}
    private void cargarProductos(Categoria categoria) {
        ...
        List<Producto> productos = control.traerProductosDeCategoria(categoria);
